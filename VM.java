...
public abstract class VM extends LexVM
{
	...
	private static Areturn areturn = new Areturn();
	...
	public static void instructionUnit()
	{
		...
		case Iload: case Istore: case Fload: case Fstore: case Aload: case Astore: 
		case Iaload: case Iastore: case Faload: case Fastore: case NewIntArray: case NewFloatArray:
		...
		case IntToFloat: case Areturn: case Return: case Ireturn: case Freturn:
		{
			switch( state )
			{
			...
			case Areturn: 	 instStore[i] = areturn;    break; 
	...
	public static void runtimeError(int i, int address, String inst, int j)
	{
		...
		case 4: msg = "Error: Division by zero";
						break;
		case 5: msg = "Error: Index out of bounds";
		}
